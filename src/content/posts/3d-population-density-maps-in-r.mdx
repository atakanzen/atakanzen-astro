...
import finalPlot from "../../assets/images/final-plot.webp";

<Image
  src={finalPlot}
  alt="Final 3D-rendered population density map"
  loading="eager"
  fetchpriority="high"
...
![Initial 2D population density plot in R](../../assets/images/r-plot.webp)
...
![Greek color palette used for the render](../../assets/images/greek-palette.webp)
...
![Titled final 3D population density render](../../assets/images/titled-final-plot.webp)
